...
//      PropertyProviders.configure(List(SystemPropertiesProvider))
//      intercept[InvalidConfigurationException](PropertyProviders.configure(List(SystemPropertiesProvider)))
//    }
  }
}
